...
if (!class_exists('MELIBU_PLUGIN_BACKEND_02')) {
    ...
    class MELIBU_PLUGIN_BACKEND_02_MENUS extends MELIBU_PLUGIN_BACKEND_02_ABSTRACT {
        ...
        public function admin_menu() {
             ...
             */
            add_menu_page('MeliBu Sharing Social Safe - ' . __('Short code', 'sharing-social-safe'), // $page_title
                    'MB Social', // $menu_title
            ...
            add_submenu_page('melibu-plugin-social-admin', // $parent_slug
                    'MeliBu Sharing Social Safe - ' . __('Options', 'sharing-social-safe'), // $page_title
...
//            );
            ...
            add_submenu_page('melibu-plugin-social-admin', // $parent_slug
                    'MeliBu Sharing Social Safe - ' . __('About', 'sharing-social-safe'), // $page_title
