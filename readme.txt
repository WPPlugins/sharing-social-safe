=== MeliBu WP Sharing Social Safe ===
Contributors: ProDeveloper, projectmate
Tags: melibu, sharing, social, safe, share, button, network, shortcode, performance, widget, social media, follow, plugin, tracking, bitly
Donate link: http://samet-tarim.de/wordpress/melibu-plugins/sharing-social-safe
...
The Melibu WP Sharing Social Safe works fully automated. 
...
The shortcode on a page automatically assumes the pages data, in a post Melibu automatically takes over the post data and the text widget accepts data on the page.
...
Therefore sat now offer the Melibu WP Sharing Social Safe parts in order not to be affected by this threat.
...
You found this project on gitHub: [sharing-social-safe](https://github.com/Samettarim/sharing-social-safe)
...
Install Melibu WP Sharing Social Safe via the plugin directory:

> **WordPress (Admin-Backend) Plugin Directory**

> 1. Go to Plugins > Add New > search for sharing social safe
> 2. Press Install Now for the Melibu WP Sharing Social Safe plugin
...
> 1. Download the Melibu WP Sharing Social Safe [WP download](https://wordpress.org/plugins/sharing-social-safe/developers/) or [gitHub](https://github.com/Samettarim/sharing-social-safe)
...
> 5. Press Install Now for the Melibu WP Sharing Social Safe plugin
...
> 1. Download the Melibu WP Sharing Social Safe [WP download](https://wordpress.org/plugins/sharing-social-safe/developers/) or [gitHub download](https://github.com/Samettarim/sharing-social-safe)
> 2. Unzip the Melibu WP Sharing Social Safe zip file
...
14. Use directly the Melibu Social Share widget, enter your short code itself or in any text widget
15. And use directly the Melibu Social Find/Follow widget, enter your short code itself or in any text widget
...
> * Melibu Copyright optinal show/hide
